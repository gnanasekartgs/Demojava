...
public class Jabang {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		d.findElement(By.id("email")).sendKeys("gnanasekar69@gmail.com");
		d.findElement(By.id("accessKey")).sendKeys("9994551583");
		d.findElement(By.id("mobile")).sendKeys("9790375500");
		Thread.sleep(1000);
		...
		d.findElement(By.id("login-username")).sendKeys("gnanasekar69@ymail.com");
